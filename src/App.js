...
function App() {
  ...
  return (
   <div className="App">
       ...
       <button type="submit" className="menu-toggle" onClick={() => handleClick()}>
...
<div className="container-3">
      ...
      <div className="column">
        <div className="row">
          <div className="cards one">
            ...
            <p className="txt-1">Tracks your indoor air quality with our innovitive device and smart sensord</p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="cards two">
            ...
            <p className="txt-2">See what's in your air and learn what factors control its quality</p>
          </div>
      ...
      <div className="row">
          <div className="cards three">
            ...
            <p className="txt-1">A 4 stage process that adapts according to its environment</p>
          </div>
      </div>
      <div className="row">
          <div className="cards four">
            ...
            <p className="txt-2">Helping you manage your air quality with minimum effort and maximum protection</p>
          </div>
      </div>
      </div>
      </div>
